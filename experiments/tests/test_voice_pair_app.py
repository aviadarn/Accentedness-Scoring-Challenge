"""Tests for the controlled own-voice experiment application."""
...
APP_PATH = Path(__file__).resolve().parents[1] / "E08-own-voice" / "app.py"
SPEC = importlib.util.spec_from_file_location("voice_pair_app_tested", APP_PATH)
...
PHONEMES = APP.PHONEMES
PairInputError = APP.PairInputError
build_argument_parser = APP.build_argument_parser
prepare_recording = APP.prepare_recording
save_and_compare = APP.save_and_compare
