...
or supplied replacement labels for training. E14 rejected stronger class
weighting under training-only grouped folds. E15 adds derived metadata without
mutating the source manifests and makes explicit that rater agreement requires
new raw votes.
