...
pseudo-speaker clusters from :mod:`accent_experiments.speaker_cluster`, this module
...
from accent_score.data import LABELS, PhoneRecord, canonicalize_prompt
    ...
    *,
    ...
    Args:
        ...
        clusters: Cluster identifier per record key, as produced by
            :meth:`accent_experiments.speaker_cluster.ClusterAssignment.mapping`
            combined with :func:`accent_experiments.speaker_embed.manifest_keys`.
    """
