...
```sh
uv sync --project experiments/E11-gopt-teacher/runtime --python 3.11

uv run --project experiments/E11-gopt-teacher/runtime \
  prepare-gopt-checkpoint \
  --output experiments/E11-gopt-teacher/runtime/artifacts/best_audio_model.pth
```
...
```sh
uv run --project experiments/E11-gopt-teacher/runtime gopt-score \
...
```sh
uv run --project experiments/E11-gopt-teacher/runtime \
  pytest experiments/E11-gopt-teacher/runtime/tests
```
